...
function startPage(self: string, error?: string): SnapHandlerResult {
  ...
  const elements: Elements = {
    ...
    intro: {
      type: "text",
      props: {
        content: "Scan recent public casts for a playful 4-letter type, axis receipts, and one next-cast prompt. Leave FID blank to type yourself.",
        size: "sm",
        align: "center",
      },
    },
    ...
    analyze_btn: {
      type: "button",
      props: { label: "Type my casts", variant: "primary" },
